...
class Puncture extends StatefulWidget {
  const Puncture({Key? key}) : super(key: key);

  @override
  _PunctureState createState() => _PunctureState();
}

class _PunctureState extends State<Puncture> {
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ListView.builder(
                      ...
                      itemCount: puncturelist.length,
                      itemBuilder: (BuildContext context, int i){
                        return GestureDetector(
                          onTap: (){},
                          child: makeGarageList(puncturelist[i]),
                        );
                      }
                  ),
                ),
  ...
  Widget makeGarageList(Garage g){
    ...
    int random = Random().nextInt(puncturelist.length);
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: ClipRRect(
