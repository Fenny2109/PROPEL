...
class NearbyGarages extends StatefulWidget {
  const NearbyGarages({Key? key}) : super(key: key);

  @override
  _NearbyGaragesState createState() => _NearbyGaragesState();
}

class _NearbyGaragesState extends State<NearbyGarages> {
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int i){
                        return GestureDetector(
                          onTap: (){},
                          child: makeGarageList(garageList[i]),
                        );
                      }
                  ),
                ),
  ...
  Widget makeGarageList(Garage g){
    ...
    int random = Random().nextInt(garageList.length);
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: ClipRRect(
