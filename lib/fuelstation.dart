...
class fuelstation extends StatefulWidget {
  ...
  @override
  _fuelstationState createState() => _fuelstationState();
}
...
class _fuelstationState extends State<fuelstation> {
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ListView.builder(
                      ...
                      itemCount: fuelstationlist.length,
                      itemBuilder: (BuildContext context, int i){
                        return GestureDetector(
                          onTap: (){},
                          child: makeGarageList(fuelstationlist[i]),
                        );
                      }
                  ),
                ),
  ...
  Widget makeGarageList(Garage g){
    ...
    int random = Random().nextInt(fuelstationlist.length);
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: ClipRRect(
